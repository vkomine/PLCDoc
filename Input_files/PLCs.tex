...
\IncludeListing{./listings/p_timer.c}{Применение периодического таймера \newline}{lst:p_timer}
...
\IncludeListing{./listings/IO_unions.c}{Пример определения имён идентификаторов \newline}{lst:IO_unions}
...
\IncludeListing{./listings/IO.c}{Обращение ко входам и выходам \newline}{lst:IO}
