...
\input{Input_files/packages}                    % Используемые пакеты
\input{Input_files/styles}                      % Применяемые стили
...
\begin{document}
    \input{Input_files/title_page}              % Титульный лист

    \input{Input_files/table_of_contents}       % Оглавление
    \input{Input_files/abbreviations}           % Список сокращений
    \input{Input_files/intro}                   % Введение
    \input{Input_files/PLC}                     % Обосбенности программ ПЛК
    \input{Input_files/intLang}   			    % Язык и среда 
    \input{Input_files/API_CNC}                 % API: управление УЧПУ
	\input{Input_files/API_MT}                  % API: управление станком
	\input{Input_files/API_Errors}              % API: обработка ошибок
    \input{Input_files/API_axis}                % API: управление осями
    \input{Input_files/API_spindel}             % API: управление шпинделями
    \input{Input_files/API_enc}                 % API: ДОС
    \input{Input_files/API_home}                % API: выезд в 0
    \input{Input_files/API_CS}                  % API: координатные системы
    \input{Input_files/API_commands}            % API: команды
    \input{Input_files/API_misc}                % API: вспомогательные функции    
    \input{Input_files/API_motion_base}         % API: управление движением - базовые функции
%    \input{Input_files/API_motion_mill}         % API: управление движением - фрезерная обработка
	\input{Input_files/PLCs}                    % Примеры ПЛК программ
    \input{Input_files/index}                   % Предметный указатель
